...
import top.wain.bolt.client.Mock2DspClient;
import top.wain.bolt.client.MockDspClient;
...
public class DataSeeder implements CommandLineRunner {
    ...
    private void seedDspPlatforms() throws Exception {
        var platforms = List.of(
                // platformCode 必须落在已部署适配器的取值范围内，否则扇出返回 Error
                new DspPlatform("plat-001", "Mock-ADX-A", MockDspClient.PLATFORM_CODE, "https://adx.mock-a.com/bid", 1000, 50),
                new DspPlatform("plat-002", "Mock-ADX-B", Mock2DspClient.PLATFORM_CODE, "https://adx.mock-b.com/bid", 2000, 100),
                new DspPlatform("plat-003", "Mock-ADX-C", MockDspClient.PLATFORM_CODE, "https://adx.mock-c.com/bid", 1500, 80)
        );
    ...
    private void seedAdSources() throws Exception {
        var sources = List.of(
                new AdSource.RtbSource("src-001", "imp-001", "plat-001", "slot-a-001", 200, 150L, 15, new AdSource.PriceMarkup.Ratio(20)),
                new AdSource.RtbSource("src-002", "imp-001", "plat-002", "slot-b-001", 250, 180L, 10, new AdSource.PriceMarkup.Fixed(220L)),
                new AdSource.FixedPriceSource("src-003", "imp-001", "plat-003", "slot-c-001", 300, 500L)
        );
